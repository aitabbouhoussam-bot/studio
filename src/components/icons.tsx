import { type LucideProps, UtensilsCrossed, Sparkles, LoaderCircle, Shell } from "lucide-react"
...
export const Icons = {
  ...
  google: (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px" {...props}>
      ...
      <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.902,35.61,44,29.59,44,24C44,22.659,43.862,21.35,43.611,20.083z"/>
    </svg>
  )
};
